...
text(I4LEdata(1,1),I4REdata(1,1), '*')
hold on
...
B5LEdata = [2	1.73924	0.04885;
          4	1.11293	0.05174;
          8	0.810005 0.04783;
          16 0.80782 0.04295]
  
B5REdata = [2	1.97215	0.04401;
          4	1.23613	0.05053;
          8	0.692964 0.06773;
          16 0.882579 0.05171]

     
B5BEdata = [2	1.80664	0.04311;
          4	1.11229	0.04682;
          8	0.856644 0.05606;
          16 0.711327 0.05629]
...
BEdata(:,2) = 10.^B5BEdata(:,2)
B5LEdata(:,3) = 10.^B5LEdata(:,3)
B5REdata(:,3) = 10.^B5REdata(:,3)
B5BEdata(:,3) = 10.^B5BEdata(:,3)

%% plot the data: always use figure(#) and clf. use xlim to set the lower and higher limits for the x axis
